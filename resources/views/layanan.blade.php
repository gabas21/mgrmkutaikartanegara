    ...
    <section class="relative pt-32 pb-24 bg-[#0B1120] overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center"
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                <a href="#section-{{ $i }}" class="px-5 py-2.5 rounded-full text-sm font-bold transition-all duration-300 active:scale-95
    ...
    <section id="section-0" class="relative py-24 lg:py-32 bg-white overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-10"
                ...
                <div class="flex items-start gap-4 bg-slate-50 rounded-2xl p-5 border border-slate-100 hover:border-red-100 hover:bg-red-50/30 transition-all duration-300 group active:scale-[0.98]">
                    <div class="w-11 h-11 rounded-xl bg-white shadow-sm flex items-center justify-center flex-shrink-0 group-hover:bg-red-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-red-500/20 transition-all duration-300 text-red-600">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div x-data="{ visible: false }" x-intersect.once="visible = true"
                    ...
                    {{-- Info Cards --}}
                    <div class="space-y-4">
                        <div class="bg-white/5 border border-white/10 rounded-2xl p-5 hover:bg-white/10 transition-colors duration-300 group active:scale-[0.98]">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch"
                            ...
                            <table class="w-full text-left border-collapse text-sm">
                                <thead>
                                    <tr class="border-b-2 border-slate-100">
                                        <th class="py-3.5 px-5 font-bold text-slate-400 text-xs uppercase tracking-wider w-10 text-center">No</th>
                                        <th class="py-3.5 px-5 font-bold text-slate-400 text-xs uppercase tracking-wider">Uraian</th>
                                        <th class="py-3.5 px-5 font-bold text-slate-400 text-xs uppercase tracking-wider">Keterangan</th>
                                    </tr>
                                </thead>
                                <tbody class="text-slate-600 font-medium divide-y divide-slate-50">
                                    ...
                                    <tr class="hover:bg-slate-50/80 transition-colors {{ $i % 2 === 1 ? 'bg-slate-50/40' : '' }}">
                                        <td class="py-3 px-5 text-center text-slate-400 text-xs font-bold">{{ $i + 1 }}</td>
                                        <td class="py-3 px-5 text-slate-800 font-bold">{{ $row[0] }}</td>
                                        <td class="py-3 px-5 text-slate-600">{{ $row[1] }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                <div class="lg:col-span-5 flex flex-col h-full">
                    <div class="flex-1 group relative rounded-3xl overflow-hidden shadow-[0_15px_50px_rgba(0,0,0,0.08)] border border-slate-100 hover:shadow-[0_25px_60px_rgba(0,0,0,0.12)] transition-all duration-500 hover:-translate-y-1">
    ...
    <section id="section-3" class="relative py-24 lg:py-32 bg-white overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8"
                ...
                <div class="group relative rounded-3xl overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-slate-100 hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-all duration-500 hover:-translate-y-1 active:scale-[0.98]">
    ...
    <section id="section-4" class="relative py-24 lg:py-32 bg-[#0B1120] overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8"
                ...
                <div class="group relative rounded-3xl overflow-hidden border border-white/10 hover:border-white/20 shadow-2xl hover:shadow-[0_25px_60px_rgba(0,0,0,0.3)] transition-all duration-500 hover:-translate-y-1 active:scale-[0.98]">
                    <div class="aspect-[4/3] bg-slate-900 relative overflow-hidden">
                        @if($item['small'])
                            <img src="{{ asset($item['img']) }}" alt="Background" class="absolute inset-0 w-full h-full object-cover blur-xl opacity-40 scale-125 pointer-events-none">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-10"
                ...
                <div class="flex items-start gap-4 bg-white/5 rounded-2xl p-5 border border-white/10 hover:border-red-500/30 hover:bg-white/10 transition-all duration-300 group active:scale-[0.98]">
                    <div class="w-11 h-11 rounded-xl bg-slate-800 shadow-sm flex items-center justify-center flex-shrink-0 group-hover:bg-red-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-red-500/20 transition-all duration-300 text-red-400 border border-white/10">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $feat['icon'] }}"/></svg>
                    </div>
                    <div>
    ...
    <section class="py-24 bg-[#0B1120] relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto px-6 text-center relative z-10"
            ...
            <a href="{{ url('/kontak') }}" wire:navigate
               class="group inline-flex items-center gap-3 bg-red-600 hover:bg-red-500 text-white font-bold py-4 px-10 rounded-full uppercase tracking-wide transition-all duration-300 hover:shadow-[0_0_30px_rgba(220,38,38,0.4)] hover:scale-105 active:scale-95">
                Hubungi Kami
