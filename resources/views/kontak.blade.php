            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 max-w-6xl mx-auto">
                ...
                <div class="w-full lg:w-5/12 relative"
                    ...
                    <div class="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border-[12px] border-white group">
                        <img src="{{ asset('images/WhatsApp-Image-2023-07-25-at-11.11.33.webp') }}" class="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out" onerror="this.src='https://placehold.co/600x800/e2e8f0/0f172a?text=Tim+Pemasaran'">
